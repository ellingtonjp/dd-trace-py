...
def _patched_route(wrapped, instance, args, kwargs):
    ...
    def _wrapper(func):
        # TODO: Use Azure's default route name instead
        # Could also be set with the decorator => @app.function_name(name="HttpTrigger1")
        function_name = kwargs.get("route", func.__name__)
        ...
        return wrapped(function_name)(wrap_function)
